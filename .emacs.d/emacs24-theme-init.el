...
(defun set-color-theme-solarized (mode)
  ...
  (let ((sym 'frame-background-mode)
    ...
    (case mode
      ('light (and (custom-theme-enabled-p 'solarized-dark) (disable-theme 'solarized-dark))
              (enable-theme 'solarized-light))
      ('dark  (and (custom-theme-enabled-p 'solarized-light) (disable-theme 'solarized-light))
